...
public abstract class AbstractTransitionSystemComponent<G extends AbstractTransitionSystem<S, T, O>,
                                                        S extends AbstractState<O>, 
                                                        T extends AbstractTransitionRelation<S, O>, 
                                                        O extends Object> 
                                                extends AbstractGraphComponent<G,S,T,O> {
